...
function affiliateMap() {
    ...
    GMaps.geocode({
        address: "6720 N Pittsburg Street, Spokane, WA 99217",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "116 E Augusta Ave, Spokane, WA 99207",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "1303 N Washington, Spokane, WA 99201",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "125 South Arthurb Spokane, WA 99202",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "3627 E Springfield Ave, Spokane, WA 99202",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "5027 East Trent Avenue, Spokane Valley, WA 99212",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
    ...
    GMaps.geocode({
        address: "12403 E. First Avenue, Spokane, WA 99216",
        callback: function (results, status) {
            if (status == 'OK') {
                var latlng = results[0].geometry.location;
                map.addMarker({
